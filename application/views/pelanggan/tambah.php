...
<div class="form-group row">
	<label for="id_pelanggan" class="col-sm-2 col-form-label">ID</label>
	<div class="col-sm-10">
		<input type="text" name="id_pelanggan" class="form-control" id="id_pelanggan" value="" placeholder="ID">
		<?php echo form_error('id_pelanggan') ?> <!-- menampilkan error saat rule id gagal -->
	</div>
</div>
<div class="form-group row">
